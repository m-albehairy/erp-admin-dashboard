...
const salesReturnsData = [
  { id: 1, returnNo: "SR-2024-001", customer: "Tech Corp", amount: "$500", reason: "Defective", date: "2024-02-20", status: "processed" },
  { id: 2, returnNo: "SR-2024-002", customer: "Global Industries", amount: "$1,250", reason: "Wrong item", date: "2024-02-19", status: "pending" },
  { id: 3, returnNo: "SR-2024-003", customer: "Local Business", amount: "$320", reason: "Not as described", date: "2024-02-18", status: "processed" },
];
...
export default function SalesReturns() {
  ...
  const paginatedData = salesReturnsData.slice(startIndex, startIndex + pageSize);

  const handlePrint = () => window.print();
  const handleExport = () => {
    const csv = [
      ["Return No", "Customer", "Amount", "Reason", "Date", "Status"],
      ...salesReturnsData.map(item => [item.returnNo, item.customer, item.amount, item.reason, item.date, item.status])
