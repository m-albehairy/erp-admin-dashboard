      ...
      <div className="space-y-6">
        ...
        {viewMode === "table" && (
          <Card className="bg-white shadow-sm border-0 overflow-hidden">
            ...
            {/* Pagination */}
            <div className="px-6 py-4 border-t border-border flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        {viewMode === "grid" && (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {paginatedData.map((item) => (
              <Card key={item.id} className="p-6 bg-white shadow-sm border-0 hover:shadow-md transition-shadow">
